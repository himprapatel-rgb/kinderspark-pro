...
export default function SettingsPage() {
  ...
  return (
    <div className="min-h-screen pb-10 app-container" style={{ background: 'var(--app-bg)' }}>
      {/* Header */}
      <div className="p-5 pt-10" style={{ background: 'linear-gradient(135deg, #6C63FF, #8B5CF6)' }}>
      ...
      <div className="px-4 py-5 space-y-4">
        ...
        <div className="rounded-2xl p-4 space-y-4" style={{ background: 'var(--app-surface)', border: '1px solid rgba(120,120,140,0.2)' }}>
          ...
          <div className="flex items-center justify-between">
            ...
            <button className="app-pressable"
              ...
              style={{ background: settings.large ? '#2DB854' : '#333' }}>
          ...
          <div className="flex items-center justify-between">
            ...
            <button className="app-pressable"
              ...
              className="w-12 h-6 rounded-full transition-all relative"
              style={{ background: settings.hc ? '#2DB854' : '#333' }}>
              <div className="absolute top-0.5 w-5 h-5 bg-white rounded-full transition-all shadow"
          ...
          <div className="flex items-center justify-between">
            ...
            <button className="app-pressable"
              ...
              className="w-12 h-6 rounded-full transition-all relative"
              style={{ background: settings.dys ? '#2DB854' : '#333' }}>
              <div className="absolute top-0.5 w-5 h-5 bg-white rounded-full transition-all shadow"
          ...
          <div className="flex flex-wrap gap-2">
            {SESSION_LIMITS.map(mins => (
              <button className="app-pressable"
                ...
                style={{
                  background: settings.stLimit === mins ? '#6C63FF' : '#2a2a4e',
          ...
          <div className="grid grid-cols-3 gap-2">
            {LANGS.map(lang => (
              <button className="app-pressable"
                ...
                style={{
                  background: settings.lang === lang.code ? '#6C63FF' : '#2a2a4e',
        ...
        <div className="rounded-2xl p-4" style={{ background: 'var(--app-surface)', border: '1px solid rgba(120,120,140,0.2)' }}>
          ...
          <div className="flex items-center justify-between">
            ...
            {permission === 'granted' ? (
              <div className="w-12 h-6 rounded-full relative" style={{ background: '#2DB854' }}>
              ...
              <button
                ...
                style={{ background: permission === 'denied' ? '#333' : '#6C63FF', color: permission === 'denied' ? 'rgba(255,255,255,0.3)' : '#fff' }}
              >
