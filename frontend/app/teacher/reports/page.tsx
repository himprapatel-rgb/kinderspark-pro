        ...
        {report && (
          <div className="rounded-2xl p-5 space-y-4" style={{ background: 'var(--app-surface)', border: '1px solid rgba(120,120,140,0.2)' }}>
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => window.print()} className="px-3 py-1 rounded-xl font-bold text-xs app-pressable" style={{ background: 'var(--app-surface-soft)', color: 'rgb(var(--foreground-rgb))', border: '1px solid var(--app-border)' }}>🖨️ Print</button>
            </div>
